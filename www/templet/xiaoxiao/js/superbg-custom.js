jQuery(function($){
    ...
    $.supersized({
        ...
        slides             : [    // Slideshow Images
								 {image : '/templet/xiaoxiao/images/bgimg/'+"bg"+(Math.floor(Math.random()*5))+".jpg"},
								
                                 {image : '/templet/xiaoxiao/images/bgimg/bg1.jpg'},
                                 {image : '/templet/xiaoxiao/images/bgimg/bg2.jpg'},
                                 {image : '/templet/xiaoxiao/images/bgimg/bg3.jpg'},
								 {image : '/templet/xiaoxiao/images/bgimg/bg4.jpg'}
                             ]
